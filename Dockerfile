...
# Install development dependencies needed for seeding
RUN npm install -g ts-node typescript

# Create proper user with a home directory
...
# Make sure we have the Prisma files and TypeScript config for seeding
