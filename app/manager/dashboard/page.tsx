...
export default function ManagerDashboard() {
  ...
  const getAttendanceColorClass = (rate: number) => {
    ...
    if (rate >= 60) return 'text-sky-700';
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">                <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition duration-300">
                ...
                </div>                <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition duration-300">
                  <div className="p-3 sm:p-5">
                    <div className="flex items-center">
                      <div className="rounded-full bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-2 sm:p-3 mr-3 sm:mr-4">
                  ...
                  <div className="p-3 sm:p-5">
                    <div className="flex items-center">
                      <div className="rounded-full bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-2 sm:p-3 mr-3 sm:mr-4">
                        <FaUniversity className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                      </div>
                      <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6">                {/* Solicitudes pendientes */}                <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                  <div className="bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-4 md:p-5 border-b border-gray-200">
                  ...
                  <div className="p-4 md:p-5">
                    <div className="grid grid-cols-1 gap-3 md:gap-4">                      <Link href="/manager/dispensas-academicas" className="flex items-center justify-between p-3 md:p-4 bg-white rounded-lg border border-blue-100 hover:bg-blue-50/70 transition-colors">
                        <div className="flex items-center">
                          <div className="bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-1.5 md:p-2 rounded-full">
                            <FaClipboardList className="h-4 w-4 md:h-5 md:w-5 text-white" />
                          </div>
                          <div className="ml-3">
                        ...
                        <div className="flex items-center">
                          <div className="bg-[#0D3C68] text-white px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs md:text-sm font-semibold">
                            {stats.pendingDispensations}
                          </div>
                        </div>
                      </Link>                        <Link href="/manager/justificaciones" className="flex items-center justify-between p-3 md:p-4 bg-white rounded-lg border border-blue-100 hover:bg-blue-50/70 transition-colors">
                        <div className="flex items-center">
                          <div className="bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-1.5 md:p-2 rounded-full">
                            <FaFileAlt className="h-4 w-4 md:h-5 md:w-5 text-white" />
                          </div>
                          <div className="ml-3">
                      ...
                      </Link>                      <Link href="/manager/firmas-docente" className="flex items-center justify-between p-3 md:p-4 bg-white rounded-lg border border-blue-100 hover:bg-blue-50/70 transition-colors">
                        <div className="flex items-center">
                          <div className="bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-1.5 md:p-2 rounded-full">
                            <FaFileSignature className="h-4 w-4 md:h-5 md:w-5 text-white" />
                          </div>
                          <div className="ml-3">
                  ...
                  <div className="p-4 md:p-5">
                    {stats.recentDispensations.length > 0 ? (
                      <div className="space-y-3">
                        ...
                        ))}                        <Link href="/manager/dispensas-academicas" className="block text-center text-sm text-[#0D3C68] hover:text-[#1a5590] mt-3 font-medium">
                  ...
                  <div className="p-4 md:p-5">
                    {stats.recentJustifications.length > 0 ? (
                      <div className="space-y-3">
                        ...
                        ))}                        <Link href="/manager/justificaciones" className="block text-center text-sm text-[#0D3C68] hover:text-[#1a5590] mt-3 font-medium">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                <div className="bg-gradient-to-r from-[#0D3C68] to-[#1a5590] p-5 border-b border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">                    {stats.attendanceByDepartment.map((dept, index) => (
                      <div key={index} className="bg-white rounded-lg p-4 border border-blue-100">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">                          <div 
                            className={`h-3 rounded-full ${
                              dept.rate >= 80 ? 'bg-gradient-to-r from-[#0D3C68] to-[#1a5590]' : 
                              dept.rate >= 60 ? 'bg-gradient-to-r from-[#1a5590] to-[#2673be]' : 
                              'bg-gradient-to-r from-[#2673be] to-[#3991e5]'
                            }`} 
                  ...
                  <div className="mt-5 text-center">                    <Link href="/manager/informes-asistencia" className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-[#0D3C68] to-[#1a5590] text-white rounded-md hover:from-[#0a3056] hover:to-[#164879] transition duration-300">
